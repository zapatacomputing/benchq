...
from benchq.data_structures import DetailedIonTrapModel, ResourceInfo
from benchq.data_structures.resource_info import DetailedIonTrapResourceInfo
...
class TestDetailedIonTrapModel:
    ...
    class TestPowerPerELU:
        def test_power_consumed_per_elu_in_kW(self):
            model = DetailedIonTrapModel()
            assert model.power_consumed_per_ELU_in_kW() == 5.0
    ...
    class TestHardwareResourceEstimates:
        ...
        def test_hardware_resource_estimates(
            ...
            assert hw_resource_info == DetailedIonTrapResourceInfo(
                power_consumed_per_elu_in_kW=5,
                ...
                * n_logical_qubits,
                ...
                total_elu_power_consumed_in_kW=5 * n_logical_qubits,
                total_elu_energy_consumed_in_kJ=5
                * n_logical_qubits
                * total_time_in_seconds,
            )
