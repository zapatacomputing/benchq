...
# juliapkg.json is undesirable because you have to put it in the same directory as the
# script that calls it. So we have to do this hacky thing to get dependencies.
