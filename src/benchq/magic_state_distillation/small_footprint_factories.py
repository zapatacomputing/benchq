...
_ERROR_RATE_FACTORY_MAPPING = {
    1e-5: (
        ...
        MagicStateFactory(
            "small footprint (15-to-1)^2_5,1,1 x (20-to-4)_11,3,5",
            6.7e-15,
            (37, 22),
            1462,
            150.0,
        ...
        MagicStateFactory(
            "small footprint (15-to-1)^4_5,1,3 x (20-to-4)_11,3,5",
            1.4e-16,
            (43, 22),
            1614,
            275.1,
        ...
        MagicStateFactory(
            "small footprint (15-to-1)^2_5,1,1 x (20-to-4)_11,5,5",
            1.3e-17,
            (51, 22),
            1958,
            150.0,
        ...
        MagicStateFactory(
            "small footprint (15-to-1)^2_5,1,1 x (20-to-4)_13,5,5",
            1.8e-20,
            (51, 22),
            2350,
            150.0,
        ...
        MagicStateFactory(
            "small footprint (15-to-1)^4_5,1,3 x (20-to-4)_15,5,5",
            2.7e-22,
            (55, 30),
            2782,
            275.0,
